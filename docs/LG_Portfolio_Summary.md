...
|-------|-------------|-------------|
| **20-skill typed library** | Typed preconditions, effects, failure modes, retention probes across 7 categories | 20 skills, DAG-validated; 81.7% plan inclusion (5.2× corrected random baseline of 15.7%; 14/20 skills at 100%) |
